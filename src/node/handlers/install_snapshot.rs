...
#[tracing::instrument(skip(state, req), fields(term = req.term, leader_id = req.leader_id, last_included_index = req.last_included_index, last_included_term = req.last_included_term))]
